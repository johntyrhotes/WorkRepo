 ...
 * 
 * @author johnty
 * @description to book hotel Adactin web page 
 * @date 26/08/2022
 *
 */
public class BookHotelPage extends BaseClass {
	...
	/**
	 * @description to send the required details to book hotel Adactin web page
	 * @param firstName
	 * @param lastName
...
//io.cucumber.datatable.
		...
		sendKeys(getTxtCreditCardNo(), ccNum);
	...
	/**
	 * @description book hotel without any fields
	 */
